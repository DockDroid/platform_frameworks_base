...
public final class OpenvmiPlatformServiceProxy {
    private static final String TAG = "OpenvmiPlatformServiceProxy";
    ...
    private static final String DESCRIPTOR = "org.openvmi.IPlatformService";
    ...
    public OpenvmiPlatformServiceProxy(WindowManagerService wm, PackageManagerService pm) {
        Log.i(TAG, "Starting up ...");

        mWm = wm;
        mPm = pm;

        mService = ServiceManager.getService("org.openvmi.PlatformService");
        if (mService == null)
    ...
    public void updateWindowState() {
        ...
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken("org.openvmi.IPlatformService");
